        ...
        <div class="field">
            <div class="ui fluid right icon input">
                <input
                    ...
                    <i id="eyeToggle" aria-hidden="true" class="eye icon"></i>
            </div>
        </div>
    <%
        if (reCaptchaEnabled) {
...
<%--            <% } %>--%>
<%--        </div>--%>
        <div class="column mobile center aligned tablet aligned computer aligned buttons tablet no-margin-right-last-child computer no-margin-right-last-child" style="display: flex; flex: 1">
            <button
                type="submit"
    ...
    %>
    <jsp:directive.include file="includes/login-style.jsp"/>
</form>
